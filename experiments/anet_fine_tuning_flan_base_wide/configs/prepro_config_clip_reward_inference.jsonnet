...

{
  ...
  caption_json_file_path: "%s/all_frame_captions_for_reranking/clip_reward_all_frame_captions.json" % DOWNLOAD_DIR,
  output_dir: "%s/%s_clip_reward_all_frame_captions" % [
    DATASET_DIR,
    std.extVar("TAG"),
  ],
