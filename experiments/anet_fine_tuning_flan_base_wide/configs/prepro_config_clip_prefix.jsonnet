...

{
  ...
  caption_json_file_path: "%s/all_frame_captions_for_reranking/clip_prefix_all_frame_captions.json" % DOWNLOAD_DIR,
  output_dir: "%s/%s_clip_prefix_all_frame_captions" % [
    DATASET_DIR,
    std.extVar("TAG"),
  ],
