...
local inference_data_config = import "./prepro_config_instruct_blip_t5_few_shot.jsonnet";
...
train_config + {
  ...
  Logger: super.Logger + {
    version: "%s_instruct_blip_t5_few_shot_seq_beam_8_prioritize_balanced_normalized/inference" % $.global_setting.tag,
  },
