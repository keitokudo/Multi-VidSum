...
local inference_data_config = import "./prepro_config_clip_reward_inference.jsonnet";
...
train_config + {
  ...
  Logger: super.Logger + {
    version: "%s_clip_reward_seq_beam_8_prioritize_balanced_normalized/inference" % $.global_setting.tag,
  },
