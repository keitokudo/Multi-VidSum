...

{
  ...
  caption_json_file_path: "%s/all_frame_captions_for_reranking/instruct_blip_t5_all_frame_captions_zero_shot.json" % DOWNLOAD_DIR,
  output_dir: "%s/%s_instruct_blip_t5_zero_shot_all_frame_captions" % [
    DATASET_DIR,
    std.extVar("TAG"),
  ],
